...
{
    explicit GeometricError(const cv::Point2d& pt) : datum(pt) { }
...
int main()
{
    ...
    for (auto i : data)
    {
        ceres::CostFunction* cost_func = new ceres::AutoDiffCostFunction<GeometricError, 1, 3>(new GeometricError(i));
